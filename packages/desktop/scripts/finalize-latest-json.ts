...
const releaseId = process.env.RENX_RELEASE
if (!releaseId) throw new Error("RENX_RELEASE is required")

const version = process.env.RENX_VERSION
if (!version) throw new Error("RENX_VERSION is required")
...
const macxTarGz = "renx-desktop-mac-x64.app.tar.gz"
const macaTarGz = "renx-desktop-mac-arm64.app.tar.gz"
