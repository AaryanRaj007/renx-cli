export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de Renx",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de Renx. ¿Quieres instalarla y reiniciar?",
