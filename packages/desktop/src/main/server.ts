...
const SIDECAR_SERVICE_NAME = "renx server"
...
export function preferAppEnv(userDataPath: string) {
  ...
  Object.assign(process.env, {
    ...
    RENX_EXPERIMENTAL_ICON_DISCOVERY: "true",
    RENX_EXPERIMENTAL_FILEWATCHER: "true",
    RENX_CLIENT: "desktop",
...
export async function checkHealth(url: string, password?: string | null): Promise<boolean> {
  ...
  if (password) {
    const auth = Buffer.from(`renx:${password}`).toString("base64")
