...
import desktopAppIcon from "../../asset/lander/renx-desktop-icon.png"
      ...
      <div data-component="container">
        ...
        <div data-component="content">
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button
                ...
                onClick={handleCopyClick("curl -fsSL https://renx.ai/install | bash")}
              >
                <code>
                  curl -fsSL https://<strong>renx.ai/install</strong> | bash
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("npm i -g renx-ai")}>
                <code>
                  npm i -g <strong>renx-ai</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("bun add -g renx-ai")}>
                <code>
                  bun add -g <strong>renx-ai</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("brew install anomalyco/tap/renx")}>
                <code>
                  brew install <strong>anomalyco/tap/renx</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("paru -S renx")}>
                <code>
                  paru -S <strong>renx</strong>
                </code>
                <CopyStatus />
              </button>
            </div>
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button data-component="cli-row" onClick={handleCopyClick("brew install --cask renx-desktop")}>
                <code>
                  brew install --cask <strong>renx-desktop</strong>
                </code>
                <CopyStatus />
              </button>
