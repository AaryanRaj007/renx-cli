...
import compareVideo from "../../asset/lander/renx-comparison-min.mp4"
import compareVideoPoster from "../../asset/lander/renx-comparison-poster.png"
...
export default function Home() {
  ...
  return (
    <main data-page="zen">
      ...
      <Meta name="renx:auth" content={loggedin() ? "true" : "false"} />
