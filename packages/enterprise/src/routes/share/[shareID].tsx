import { Message, Model, Part, Session, SessionStatus, SnapshotFileDiff, UserMessage } from "@renx-ai/sdk/v2"
import { SessionTurn } from "@renx-ai/ui/session-turn"
import { SessionReview } from "@renx-ai/ui/session-review"
import { DataProvider } from "@renx-ai/ui/context"
import { FileComponentProvider } from "@renx-ai/ui/context/file"
import { WorkerPoolProvider } from "@renx-ai/ui/context/worker-pool"
import { createAsync, query, useParams } from "@solidjs/router"
import { createMemo, createSignal, ErrorBoundary, For, Match, Show, Switch } from "solid-js"
import { Share } from "~/core/share"
import { Logo, Mark } from "@renx-ai/ui/logo"
import { IconButton } from "@renx-ai/ui/icon-button"
import { ProviderIcon } from "@renx-ai/ui/provider-icon"
import { iife } from "@renx-ai/core/util/iife"
import { Binary } from "@renx-ai/core/util/binary"
import { NamedError } from "@renx-ai/core/util/error"
import { DateTime } from "luxon"
import { createStore } from "solid-js/store"
import z from "zod"
import NotFound from "../[...404]"
import { Tabs } from "@renx-ai/ui/tabs"
import { MessageNav } from "@renx-ai/ui/message-nav"
import { FileSSR } from "@renx-ai/ui/file-ssr"
...
const ClientOnlyWorkerPoolProvider = clientOnly(() =>
  import("@renx-ai/ui/pierre/worker").then((m) => ({
      ...
      <Show when={data()}>
        {(data) => {
          ...
          const ogImage = createMemo(() => {
            ...
            return `https://social-cards.sst.dev/renx-share/${encodedTitle}.png?model=${modelParam}&version=${version}&id=${data().shareID}`
          })

          return (
            <>
              <Show when={info().title}>
                <Title>{info().title} | Renx</Title>
              </Show>
              <Meta name="description" content="renx - The AI coding agent built for the terminal." />
                        ...
                        <div class="relative bg-background-stronger w-screen h-screen overflow-hidden flex flex-col">
                          <header class="h-12 px-6 py-2 flex items-center justify-between self-stretch bg-background-base border-b border-border-weak-base">
                            ...
                            <div class="flex gap-3 items-center">
                              <IconButton
                                as={"a"}
                                href="https://github.com/anomalyco/renx"
                                target="_blank"
                                icon="github"
                                variant="ghost"
                              />
