...
Current total: `56` files in `packages/renx/src`.
...
- converge these on one shared `withInstance(...)` Effect entry helper instead of renxd `Instance.provide(...)`
...
- path: `/Users/kit/code/open-source/renx-worktrees/instance-effect-shift`
