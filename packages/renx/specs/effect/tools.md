...
Practical reference for the current tool-migration state in `packages/renx`.
...
Tool tests should use the existing Effect helpers in `packages/renx/test/lib/effect.ts`:
