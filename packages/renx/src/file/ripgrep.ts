...
import { sanitizedProcessEnv } from "@renx/core/util/renx-process"
...
export class Service extends Context.Service<Service, Interface>()("@renx/Ripgrep") {}
    ...
    Effect.gen(function* () {
      ...
      const tree: Interface["tree"] = Effect.fn("Ripgrep.tree")(function* (input: TreeInput) {
        ...
        for (const file of list) {
          if (file.includes(".renx")) continue
