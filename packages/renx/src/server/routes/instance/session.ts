  ...
  new Hono()
    .get(
      ...
      describeRoute({
        ...
        description: "Get a list of all Renx sessions, sorted by most recently updated.",
    ...
    .get(
      ...
      describeRoute({
        summary: "Get session",
        description: "Retrieve detailed information about a specific Renx session.",
        tags: ["Session"],
    ...
    .post(
      ...
      describeRoute({
        ...
        description: "Create a new Renx session for interacting with AI assistants and managing conversations.",
