...
const LegacyComponentDescriptions = {
  LogLevel: "Log level",
  ServerConfig: "Server configuration for renx serve and web commands",
...
function fixSelfReferencingComponents(spec: OpenApiSpec) {
  ...
  const raw = OpenApi.fromApi(RenxHttpApi) as unknown as OpenApiSpec
...
export const PublicApi = RenxHttpApi.annotateMerge(
  OpenApi.annotations({
    title: "renx",
    version: "1.0.0",
