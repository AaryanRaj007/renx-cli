...
export const RootHttpApi = HttpApi.make("renx-root").addHttpApi(ControlApi).addHttpApi(GlobalApi)

export const InstanceHttpApi = HttpApi.make("renx-instance")
...
export const RenxHttpApi = HttpApi.make("renx")
