...
>()("@renx/ExperimentalHttpApiWorkspaceRouteContext") {}
...
>()("@renx/ExperimentalHttpApiWorkspaceRouting") {}
...
function configuredWorkspaceID(): WorkspaceID | undefined {
  return Flag.RENX_WORKSPACE_ID ? WorkspaceID.make(Flag.RENX_WORKSPACE_ID) : undefined
}
...
function defaultDirectory(request: HttpServerRequest.HttpServerRequest, url: URL): string {
  return url.searchParams.get("directory") || request.headers["x-renx-directory"] || process.cwd()
}
