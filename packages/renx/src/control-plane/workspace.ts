...
export class Service extends Context.Service<Service, Interface>()("@renx/Workspace") {}
...
export const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const startSync = Effect.fn("Workspace.startSync")(function* (space: Info) {
      if (!Flag.RENX_EXPERIMENTAL_WORKSPACES) return
    ...
    const create = Effect.fn("Workspace.create")(function* (input: CreateInput) {
      ...
      const env = {
        RENX_AUTH_CONTENT: JSON.stringify(yield* auth.all()),
        RENX_WORKSPACE_ID: config.id,
        RENX_EXPERIMENTAL_WORKSPACES: "true",
