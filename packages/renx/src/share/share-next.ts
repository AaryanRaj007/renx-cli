import type * as SDK from "@renx/sdk/v2"
...
const disabled = process.env["RENX_DISABLE_SHARE"] === "true" || process.env["RENX_DISABLE_SHARE"] === "1"
...
export class Service extends Context.Service<Service, Interface>()("@renx/ShareNext") {}
