 ...
 *   "@renx/ServerAuthConfig",
 *   {
 *     password: Config.string("RENX_SERVER_PASSWORD").pipe(Config.option),
 *     username: Config.string("RENX_SERVER_USERNAME").pipe(Config.withDefault("renx")),
 *   },
 * ) {}
 *
