...
import * as EffectLogger from "@renx/core/effect/logger"
...
export class Service extends Context.Service<Service, Interface>()("@renx/SessionPrompt") {}
...
export const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const insertReminders = Effect.fn("SessionPrompt.insertReminders")(function* (input: {
      ...
      if (!Flag.RENX_EXPERIMENTAL_PLAN_MODE) {
