import type { TuiDialogSelectOption, TuiPluginApi, TuiRouteDefinition, TuiSlotProps } from "@renx/plugin/tui"
...
import type { useRenxKeymap } from "../keymap"
...
type Input = {
  ...
  keymap: ReturnType<typeof useRenxKeymap>
