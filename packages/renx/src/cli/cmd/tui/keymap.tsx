...
export const RenxKeymapProvider = KeymapProvider
export const useRenxKeymap = useKeymap
...
export function registerRenxKeymap(keymap: OpenTuiKeymap, renderer: CliRenderer, config: TuiConfig.Resolved) {
