...
import type { RenxClient, PermissionRequest, QuestionRequest, ToolPart } from "@renx/sdk/v2"
...
type PromptModel = Parameters<RenxClient["session"]["prompt"]>[0]["model"]
type PromptInput = Parameters<RenxClient["session"]["prompt"]>[0]

export type RunPromptPart = NonNullable<PromptInput["parts"]>[number]

export type RunCommand = NonNullable<Awaited<ReturnType<RenxClient["command"]["list"]>>["data"]>[number]

export type RunProvider = NonNullable<Awaited<ReturnType<RenxClient["provider"]["list"]>>["data"]>["all"][number]
...
export type RunAgent = NonNullable<Awaited<ReturnType<RenxClient["app"]["agents"]>>["data"]>[number]

type RunResourceMap = NonNullable<Awaited<ReturnType<RenxClient["experimental"]["resource"]["list"]>>["data"]>
...
export type PermissionReply = Parameters<RenxClient["permission"]["reply"]>[0]

export type QuestionReply = Parameters<RenxClient["question"]["reply"]>[0]

export type QuestionReject = Parameters<RenxClient["question"]["reject"]>[0]
