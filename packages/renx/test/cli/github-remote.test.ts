...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/renx.git")).toEqual({ owner: "sst", repo: "renx" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/renx")).toEqual({ owner: "sst", repo: "renx" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/renx.git")).toEqual({ owner: "sst", repo: "renx" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/renx")).toEqual({ owner: "sst", repo: "renx" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/renx.git")).toEqual({ owner: "sst", repo: "renx" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/renx")).toEqual({ owner: "sst", repo: "renx" })
})
