...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders RENX_CALLER", () => {
    process.env["RENX_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode RENX_CALLER", () => {
    process.env["RENX_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown RENX_CALLER", () => {
    process.env["RENX_CALLER"] = "unknown"
