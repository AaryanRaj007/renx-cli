...
// test/preload.ts pins RENX_MODELS_PATH to a fixture so other tests can
...
// bun process.
const ORIGINAL_MODELS_PATH = Flag.RENX_MODELS_PATH
const ORIGINAL_DISABLE_FETCH = Flag.RENX_DISABLE_MODELS_FETCH
beforeAll(() => {
  Flag.RENX_MODELS_PATH = undefined
  Flag.RENX_DISABLE_MODELS_FETCH = true
})
afterAll(() => {
  Flag.RENX_MODELS_PATH = ORIGINAL_MODELS_PATH
  Flag.RENX_DISABLE_MODELS_FETCH = ORIGINAL_DISABLE_FETCH
})
