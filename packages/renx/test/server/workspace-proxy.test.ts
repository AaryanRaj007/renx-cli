...
describe("HttpApi workspace proxy", () => {
  ...
  it.live("strips renx-internal headers and merges extra headers", () =>
    Effect.gen(function* () {
      ...
      expect(forwarded["x-renx-directory"]).toBeUndefined()
      expect(forwarded["x-renx-workspace"]).toBeUndefined()
