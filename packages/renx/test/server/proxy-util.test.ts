...
describe("ProxyUtil", () => {
  ...
  describe("headers", () => {
    ...
    test("strips renx-specific headers", () => {
      const req = new Request("http://localhost", {
        headers: {
          "x-renx-directory": "/home/user/project",
      ...
      const result = ProxyUtil.headers(req)
      expect(result.get("x-renx-directory")).toBeNull()
      expect(result.get("x-renx-workspace")).toBeNull()
