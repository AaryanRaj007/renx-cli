...
import { base64Encode } from "@renx/core/util/encode"
import { decode64 } from "@/utils/base64"
import { ResizeHandle } from "@renx/ui/resize-handle"
import { Button } from "@renx/ui/button"
import { IconButton } from "@renx/ui/icon-button"
import { Tooltip } from "@renx/ui/tooltip"
...
import { Session, type Message } from "@renx/sdk/v2/client"
...
import { showToast, Toast, toaster } from "@renx/ui/toast"
...
import { retry } from "@renx/core/util/retry"
...
import { useTheme, type ColorScheme } from "@renx/ui/theme/context"
...
export default function Layout(props: ParentProps) {
  ...
  const sidebarContent = (mobile?: boolean) => (
    <SidebarContent
      ...
      onOpenHelp={() => platform.openLink("https://renx.ai/desktop-feedback")}
      renderPanel={() =>
