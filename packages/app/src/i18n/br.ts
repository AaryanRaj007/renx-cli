export const dict = {
  ...
  "dialog.provider.renx.note": "Modelos selecionados incluindo Claude, GPT, Gemini e mais",
  "dialog.provider.renx.tagline": "Modelos otimizados e confiáveis",
  "dialog.provider.renxGo.tagline": "Assinatura de baixo custo para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo Renx",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no Renx.",
  ...
  "provider.connect.renxZen.line1":
    "Renx Zen oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  "provider.connect.renxZen.line2":
    "Com uma única chave de API você terá acesso a modelos como Claude, GPT, Gemini, GLM e mais.",
  "provider.connect.renxZen.visit.prefix": "Visite ",
  "provider.connect.renxZen.visit.link": "renx.ai/zen",
  "provider.connect.renxZen.visit.suffix": " para obter sua chave de API.",
  "provider.connect.oauth.code.visit.prefix": "Visite ",
  "provider.connect.oauth.code.visit.link": "este link",
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no Renx.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no Renx.",
  ...
  "dialog.plugins.empty": "Plugins configurados em renx.json",
  ...
  "dialog.server.description": "Trocar para qual servidor Renx este aplicativo se conecta.",
  ...
  "toast.update.description": "Uma nova versão do Renx ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do Renx",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (renx.json)",
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: Renx ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "Renx inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor Renx dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do Renx",
  "settings.general.row.appearance.title": "Aparência",
  "settings.general.row.appearance.description": "Personalize como o Renx aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o Renx segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o Renx é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o Renx iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do Renx.",
