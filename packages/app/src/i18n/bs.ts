export const dict = {
  ...
  "dialog.provider.renx.note": "Kurirani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.renx.tagline": "Pouzdani optimizovani modeli",
  "dialog.provider.renxGo.tagline": "Povoljna pretplata za sve",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje Renx",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u Renx-u.",
  ...
  "provider.connect.renxZen.line1":
    "Renx Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  "provider.connect.renxZen.line2":
    "Sa jednim API ključem dobijaš pristup modelima kao što su Claude, GPT, Gemini, GLM i drugi.",
  "provider.connect.renxZen.visit.prefix": "Posjeti ",
  "provider.connect.renxZen.visit.link": "renx.ai/zen",
  "provider.connect.renxZen.visit.suffix": " da preuzmeš svoj API ključ.",
  "provider.connect.oauth.code.visit.prefix": "Posjeti ",
  "provider.connect.oauth.code.visit.link": "ovaj link",
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u Renx-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u Renx-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u renx.json",
  ...
  "dialog.server.description": "Promijeni na koji se Renx server ova aplikacija povezuje.",
  ...
  "toast.update.description": "Nova verzija Renx-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku Renx timu",
  ...
  "error.chain.checkConfig": "Provjeri konfiguraciju (renx.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: Renx još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "Renx uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni Renx server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u Renx-u",
  "settings.general.row.appearance.title": "Izgled",
  "settings.general.row.appearance.description": "Prilagodi kako Renx izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li Renx prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu Renx-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se Renx pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju Renx-a.",
