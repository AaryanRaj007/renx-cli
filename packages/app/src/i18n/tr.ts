...
export const dict = {
  ...
  "dialog.provider.renx.note": "Claude, GPT, Gemini ve daha fazlasını içeren seçilmiş modeller",
  "dialog.provider.renx.tagline": "Güvenilir optimize edilmiş modeller",
  "dialog.provider.renxGo.tagline": "Herkes için düşük maliyetli abonelik",
  ...
  "dialog.model.unpaid.freeModels.title": "Renx tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve Renx'da {{provider}} modellerini kullanmak için {{provider}} API anahtarınızı girin.",
  ...
  "provider.connect.renxZen.line1":
    "Renx Zen, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  ...
  "provider.connect.renxZen.visit.prefix": "",
  "provider.connect.renxZen.visit.link": "renx.ai/zen",
  "provider.connect.renxZen.visit.suffix": " adresini ziyaret ederek API anahtarınızı alın.",
  "provider.connect.oauth.code.visit.prefix":
    "Hesabınızı bağlamak ve Renx'da {{provider}} modellerini kullanmak için ",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak Renx'da {{provider}} modellerini kullanın.",
  ...
  "dialog.plugins.empty": "Eklentiler renx.json içinde yapılandırılır",
  ...
  "dialog.server.description": "Bu uygulamanın hangi Renx sunucusuna bağlanacağını değiştirin.",
  ...
  "toast.update.description": "Renx'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı Renx ekibine bildirin",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızı (renx.json) sağlayıcı/model adlarını kontrol edin",
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" başarısız oldu. Not: Renx henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "Renx ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "Renx Masaüstü",
  ...
  "settings.desktop.wsl.description": "Renx sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "Renx'un görünüm dilini değiştirin",
  "settings.general.row.appearance.title": "Görünüm",
  "settings.general.row.appearance.description": "Renx'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "Renx'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Renx'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "Renx başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "Renx'un en son sürümünü kullanıyorsunuz.",
