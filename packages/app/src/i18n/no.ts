...
export const dict = {
  ...
  "dialog.provider.renx.note": "Utvalgte modeller inkludert Claude, GPT, Gemini og mer",
  "dialog.provider.renx.tagline": "Pålitelige, optimaliserte modeller",
  "dialog.provider.renxGo.tagline": "Rimelig abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av Renx",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i Renx.",
  ...
  "provider.connect.renxZen.line1":
    "Renx Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  "provider.connect.renxZen.line2":
    "Med én enkelt API-nøkkel får du tilgang til modeller som Claude, GPT, Gemini, GLM og flere.",
  "provider.connect.renxZen.visit.prefix": "Besøk ",
  "provider.connect.renxZen.visit.link": "renx.ai/zen",
  "provider.connect.renxZen.visit.suffix": " for å hente API-nøkkelen din.",
  "provider.connect.oauth.code.visit.prefix": "Besøk ",
  "provider.connect.oauth.code.visit.link": "denne lenken",
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i Renx.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i Renx.",
  ...
  "dialog.plugins.empty": "Plugins konfigurert i renx.json",
  ...
  "dialog.server.description": "Bytt hvilken Renx-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av Renx ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til Renx-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (renx.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at Renx ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "Renx inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør Renx-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for Renx",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan Renx ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description": "Velg om Renx skal følge systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan Renx er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når Renx starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av Renx.",
