...
export const loadMcpQuery = (directory: string, sdk: RenxClient) =>
  queryOptions({
...
export const loadLspQuery = (directory: string, sdk: RenxClient) =>
  queryOptions({
...
function createGlobalSync() {
  ...
  const sdkCache = new Map<string, RenxClient>()
