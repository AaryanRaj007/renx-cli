...
import { ensureProcessMetadata } from "../util/renx-process"
...
export function resource(): { serviceName: string; serviceVersion: string; attributes: Record<string, string> } {
  ...
  return {
    ...
    attributes: {
      ...
      "renx.client": Flag.RENX_CLIENT,
      "renx.process_role": processMetadata.processRole,
      "renx.run_id": processMetadata.runID,
