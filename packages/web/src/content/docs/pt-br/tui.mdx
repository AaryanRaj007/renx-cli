---
title: TUI
description: Usando a interface de usuário de terminal renx.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

O renx fornece uma interface de terminal interativa ou TUI para trabalhar em seus projetos com um LLM.

Executar renx inicia o TUI para o diretório atual.
...
Ao usar o TUI do renx, você pode digitar `/` seguido pelo nome de um comando para executar ações rapidamente. Por exemplo:
...
Adicione um provedor ao renx. Permite que você selecione entre os provedores disponíveis e adicione suas chaves de API.
...
Isso é separado do `renx.json`, que configura o comportamento do servidor/runtime.
...
Use `RENX_TUI_CONFIG` para carregar um caminho de configuração TUI personalizado.
