...
Możesz zdefiniować polecenia w `renx.json` lub w plikach w katalogu `commands/`.

---

### JSON

Użyj opcji `command` w swojej konfiguracji renx:
...
- Globalnie: `~/.config/renx/commands/`
- Na projekt: `.renx/commands/`
...
renx zawiera kilka wbudowanych poleceń, takich jak `/init`, `/undo`, `/redo`, `/share`, `/help`; [dowiedz się więcej](/docs/tui#commands).
