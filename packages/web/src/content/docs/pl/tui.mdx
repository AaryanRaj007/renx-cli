---
title: TUI
description: Korzystanie z interfejsu użytkownika terminala renx.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

renx zapewnia interaktywny interfejs terminala lub TUI do pracy nad projektami za pomocą LLM.

Uruchomienie renx uruchamia TUI dla bieżącego katalogu.
...
Korzystając z TUI renx, możesz wpisać `/`, po którym następuje nazwa polecenia, aby szybko wykonać działania. Na przykład:
...
Dodaj dostawcę do renx. Umożliwia wybór dostępnych dostawców i dodanie ich kluczy API.
...
Jest to oddzielny plik od `renx.json`, który konfiguruje zachowanie serwera/runtime.
...
Użyj `RENX_TUI_CONFIG`, aby załadować niestandardową ścieżkę konfiguracji TUI.
