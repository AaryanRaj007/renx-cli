---
title: Zen
description: Wyselekcjonowana lista modeli dostarczonych przez Renx.
---
...
Renx Zen to lista przetestowanych i zweryfikowanych modeli udostępniana przez zespół Renx.

:::note
Renx Zen jest obecnie w wersji beta.
:::

Zen działa jak każdy inny dostawca w Renx. Logujesz się do Renx Zen i otrzymujesz
...
:::tip
Przetestowaliśmy wybraną grupę modeli i dostawców, którzy dobrze współpracują z Renx.
:::
...
Renx Zen to brama AI, która daje dostęp do tych modeli.

---

## Jak to działa

Renx Zen działa jak każdy inny dostawca w Renx.

1. Logujesz się do **<a href={console}>Renx Zen</a>**, dodajesz dane
   rozliczeniowe i kopiujesz swój klucz API.
2. Uruchamiasz polecenie `/connect` w TUI, wybierasz Renx Zen i wklejasz swój klucz API.
...
[ID modelu](/docs/config/#models) w Twojej konfiguracji Renx używa formatu
`renx/<model-id>`. Na przykład dla GPT 5.5 użyjesz w konfiguracji
`renx/gpt-5.5`.
...
- MiniMax M2.5 Free jest dostępny w Renx przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Ling 2.6 Flash Free jest dostępny w Renx przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Hy3 Preview Flash Free jest dostępny w Renx przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Nemotron 3 Super Free jest dostępny w Renx przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Big Pickle to stealth model, który jest darmowy w Renx przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
...
4. Nie tworzyć **lock-in**, pozwalając używać tego z dowolnym innym agentem kodującym. I zawsze pozwalać Ci używać w Renx także dowolnego innego dostawcy.
