...
ใช้ส่วน `command` ในไฟล์ [config](/docs/config) ของ Renx:
...
- ระดับผู้ใช้ (Global): `~/.config/renx/commands/`
- ระดับโปรเจ็กต์: `.renx/commands/`
...
Renx มีคำสั่งในตัวหลายคำสั่ง เช่น `/init`, `/undo`, `/redo`, `/share`, `/help` [เรียนรู้เพิ่มเติม](/docs/tui#คำสั่ง)
