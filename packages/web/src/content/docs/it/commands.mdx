...
Puoi aggiungere comandi personalizzati tramite la config di Renx o creando file markdown nella directory `commands/`.

---

### JSON

Usa l'opzione `command` nella [config](/docs/config) di Renx:
...
- Globale: `~/.config/renx/commands/`
- Per progetto: `.renx/commands/`
...
renx include diversi comandi integrati come `/init`, `/undo`, `/redo`, `/share`, `/help`; [scopri di piu](/docs/tui#commands).
