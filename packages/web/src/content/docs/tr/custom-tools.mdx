---
title: Özel Araçlar
description: LLM'un renx'da çağırabileceği araçları birleştirebilir.
---

Özel araçlar, LLM'un konuşmalar sırasında arayabileceği, oluşturduğunuz işlevlerdir. renx'un [built-in tools](/docs/tools) ile birlikte `read`, `write` ve `bash` gibi çalışırlar.
...
- Yerel olarak bunları projenizin `.renx/tools/` dizinine yerleştirerek.
- Veya küresel olarak bunları `~/.config/renx/tools/` içine yerleştirerek.
