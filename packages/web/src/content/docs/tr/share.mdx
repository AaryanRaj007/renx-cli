---
title: Paylasim
description: renx konusmalarini genel baglantilarla paylasin.
---

renx'un paylasim ozelligi, konusmalariniz icin genel baglantilar olusturmanizi saglar. Boylece ekip arkadaslarinizla birlikte calisabilir veya diger kisilerden yardim alabilirsiniz.
...
Bir konusmayi paylastiginizda renx:
...
renx, konusmalarin nasil paylasilacagini kontrol eden uc farkli paylasim modu sunar:

---

### Manuel (varsayilan)

Varsayilan olarak renx manuel paylasim modunu kullanir. Oturumlar otomatik paylasilmaz, ancak `/share` komutuyla manuel olarak paylasabilirsiniz:
...
Bunu belirli bir projede tum ekip icin zorunlu kilmak icin proje icindeki `renx.json` dosyasina ekleyip Git'e commit edin.
...
Kurulusunuzda renx kullanimi icin [daha fazla bilgi alin](/docs/enterprise).
