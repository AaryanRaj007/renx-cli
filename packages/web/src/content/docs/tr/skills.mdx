...
Ajan becerileri, renx'un deponuzdan veya ev dizininizden tekrar kullanilabilir talimatlari kesfetmesini saglar.
...
renx su konumlari tarar:

- Proje konfigurasyonu: `.renx/skills/<name>/SKILL.md`
- Genel konfigurasyon: `~/.config/renx/skills/<name>/SKILL.md`
...
Proje yerel yollarinda renx, mevcut calisma dizininizden baslayip git worktree kokune kadar yukari cikar.
Bu sirada `skills/*/SKILL.md` altindaki eslesen `.renx/` dosyalarini ve `.claude/skills/*/SKILL.md` ya da `.agents/skills/*/SKILL.md` dosyalarini yukler.

Genel tanimlar da `~/.config/renx/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` ve `~/.agents/skills/*/SKILL.md` yollarindan yuklenir.
...
`.renx/skills/git-release/SKILL.md` dosyasini soyle olusturun:
...
renx, `skill` araci aciklamasinda mevcut becerileri listeler.
...
`renx.json` icinde pattern tabanli izinlerle ajanlarin hangi becerilere erisecegini kontrol edin:
...
**Yerlesik ajanlar icin** (`renx.json` icinde):
