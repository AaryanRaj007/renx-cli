---
title: TUI
description: Usando la interfaz de usuario del terminal Renx.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Renx proporciona una interfaz de terminal interactiva o TUI para trabajar en sus proyectos con un LLM.

Al ejecutar Renx se inicia TUI para el directorio actual.
...
Cuando utilice Renx TUI, puede escribir `/` seguido de un nombre de comando para ejecutar acciones rápidamente. Por ejemplo:
...
Agregue un proveedor a Renx. Le permite seleccionar entre proveedores disponibles y agregar sus claves API.
...
Esto es independiente de `renx.json`, que configura el comportamiento del servidor/tiempo de ejecución.
...
Utilice `RENX_TUI_CONFIG` para cargar una ruta de configuración de TUI personalizada.
