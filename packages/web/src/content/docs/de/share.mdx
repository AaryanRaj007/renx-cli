---
title: Teilen
description: Teile Renx-Unterhaltungen per oeffentlichem Link.
---

Mit der Share-Funktion erstellst du oeffentliche Links zu Renx-Unterhaltungen.
...
Wenn du eine Unterhaltung teilst, macht Renx Folgendes:
...
Renx hat drei Modi, die das Teilen steuern:

---

### Manuell (Standard)

Standardmaessig nutzt Renx den manuellen Modus.
...
Wenn das fuer ein Projekt teamweit gelten soll, lege es in der Projekt-`renx.json` fest und committe die Datei.
...
[Mehr dazu](/docs/enterprise), wie du renx in deiner Organisation einsetzt.
