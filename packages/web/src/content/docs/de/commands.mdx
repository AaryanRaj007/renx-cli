...
Erstellen Sie `.renx/commands/test.md`:

```md title=".renx/commands/test.md"
---
...
Sie können benutzerdefinierte Befehle über die Renx-Konfiguration hinzufügen oder indem Sie Markdown-Dateien im Verzeichnis `commands/` erstellen.

---

### JSON

Verwenden Sie die Option `command` in Ihrem Renx [config](/docs/config):

```json title="renx.jsonc" {4-12}
{
...
- Global: `~/.config/renx/commands/`
- Pro Projekt: `.renx/commands/`

```markdown title="~/.config/renx/commands/test.md"
---
description: Run tests with coverage
agent: build
model: anthropic/claude-3-5-sonnet-20241022
...
```md title=".renx/commands/component.md"
---
...
```md title=".renx/commands/create-file.md"
---
...
```md title=".renx/commands/analyze-coverage.md"
---
...
```md title=".renx/commands/review-changes.md"
---
...
```md title=".renx/commands/review-component.md"
---
...
Renx enthält mehrere integrierte Befehle wie `/init`, `/undo`, `/redo`, `/share`, `/help`; [mehr erfahren](/docs/tui#commands).
