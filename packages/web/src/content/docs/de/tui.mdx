---
title: TUI
description: Arbeite mit Renx in der Terminal-Oberflaeche.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Renx bietet eine interaktive Terminaloberflaeche (TUI), um mit einem LLM an deinen Projekten zu arbeiten.

Ohne weitere Argumente startet Renx die TUI im aktuellen Verzeichnis.
...
In der Renx-TUI kannst du `/` plus Befehlsnamen eingeben, um Aktionen schnell auszufuehren.
Zum Beispiel:
...
Fuegt einen Provider zu Renx hinzu. Erlaubt die Auswahl aus verfuegbaren Providern und das Hinzufuegen ihrer API-Keys.
...
Dies ist getrennt von `renx.json`, welche das Server-/Runtime-Verhalten konfiguriert.
...
Verwende `RENX_TUI_CONFIG`, um einen benutzerdefinierten TUI-Konfigurationspfad zu laden.
