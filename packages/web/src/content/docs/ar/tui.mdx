---
title: TUI
description: استخدام واجهة المستخدم TUI في Renx.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

يوفّر Renx واجهة terminal تفاعلية (TUI) للعمل على مشاريعك باستخدام LLM.

يؤدي تشغيل Renx إلى بدء واجهة TUI للدليل الحالي.
...
عند استخدام واجهة Renx في terminal، يمكنك كتابة `/` متبوعة باسم أمر لتنفيذ الإجراءات بسرعة. مثلا:
...
أضف موفّرا إلى Renx. يتيح لك اختيار أحد الموفّرين المتاحين وإضافة مفاتيح API الخاصة بهم.
...
اخرج من Renx. _الأسماء المستعارة_: `/quit`, `/q`
...
يمكنك تخصيص سلوك واجهة TUI عبر ملف إعدادات Renx.
...
استخدم `RENX_TUI_CONFIG` لتحميل مسار إعدادات TUI مخصص.
