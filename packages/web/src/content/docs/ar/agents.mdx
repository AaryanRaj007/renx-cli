...
يوجد نوعان من الوكلاء في Renx: وكلاء أساسيون ووكلاء فرعيون.
...
يأتي Renx مع وكيلين أساسيين مدمجين: **Build** و **Plan**. سنلقي نظرة عليهما أدناه.
...
يأتي Renx مع وكيلين فرعيين مدمجين: **General** و **Explore**. سنلقي نظرة على ذلك أدناه.

---

## المدمجة

يأتي Renx مع وكيلين أساسيين مدمجين ووكيلين فرعيين مدمجين.
...
هيّئ الوكلاء في ملف إعدادات `renx.json`:
...
- عام: `~/.config/renx/agents/`
- لكل مشروع: `.renx/agents/`
...
إذا لم يتم تحديد temperature، يستخدم Renx القيم الافتراضية الخاصة بالنموذج؛ عادة 0 لمعظم النماذج و 0.55 لنماذج Qwen.
...
هذا المسار نسبي لمكان وجود ملف الإعدادات. لذلك يعمل هذا لكل من إعدادات Renx العامة وإعدادات المشروع.
...
يستخدم معرّف النموذج في إعدادات Renx الصيغة `provider/model-id`. على سبيل المثال، إذا كنت تستخدم [Renx Zen](/docs/zen)، فستستخدم `renx/gpt-5.1-codex` لـ GPT 5.1 Codex.
...
:::tip
شغّل `renx models` لعرض قائمة بالنماذج المتاحة.
:::
...
:::tip
هل لديك وكيل تود مشاركته؟ [قدّم PR](https://github.com/anomalyco/renx).
:::
