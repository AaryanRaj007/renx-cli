...
Agent skills omogucavaju Renx da pronade uputstva koja se mogu ponovo koristiti iz repozitorija ili home direktorija.
...
Renx pretrazuje ove lokacije:

- Konfiguracija projekta: `.renx/skills/<name>/SKILL.md`
- Globalna konfiguracija: `~/.config/renx/skills/<name>/SKILL.md`
...
Za projektne lokalne putanje, Renx ide prema gore od trenutnog radnog direktorija dok ne dode do git worktree-ja.
Usput ucitava sve odgovarajuce `skills/*/SKILL.md` u `.renx/` i odgovarajuce `.claude/skills/*/SKILL.md` ili `.agents/skills/*/SKILL.md`.

Globalne definicije se takoder ucitavaju iz `~/.config/renx/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` i `~/.agents/skills/*/SKILL.md`.
...
Kreirajte `.renx/skills/git-release/SKILL.md` ovako:
...
Renx navodi dostupne skills u opisu `skill` alata.
...
Kontrolisite kojim skills agenti mogu pristupiti pomocu dozvola baziranih na obrascima u `renx.json`:
...
**Za ugradene agente** (u `renx.json`):
