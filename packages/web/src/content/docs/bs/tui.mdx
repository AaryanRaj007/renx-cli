---
title: TUI
description: Korištenje korisničkog interfejsa Renx terminala.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Renx pruža interaktivni terminalski interfejs ili TUI za rad na vašim projektima sa LLM.

Pokretanje Renx pokreće TUI za trenutni direktorij.
...
Kada koristite Renx TUI, možete upisati `/` nakon čega slijedi ime komande da biste brzo izvršili radnje. na primjer:
...
Dodajte provajdera u Renx. Omogućava vam da odaberete između dostupnih provajdera i dodate njihove API ključeve.
...
Izađite iz Renx. _Aliases_: `/quit`, `/q`
...
Ovo je odvojeno od `renx.json`, koji konfiguriše ponašanje servera/izvršavanja.
...
Koristite `RENX_TUI_CONFIG` da učitate prilagođenu putanju TUI konfiguracije.
