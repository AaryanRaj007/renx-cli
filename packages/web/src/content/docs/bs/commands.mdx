...
Možete dodati prilagođene komande kroz Renx konfiguraciju ili kreiranjem markdown datoteka u direktoriju `commands/`.

---

### JSON

Koristite opciju `command` u svom Renx [config](/docs/config):
...
- Globalno: `~/.config/renx/commands/`
- Po projektu: `.renx/commands/`
...
Renx uključuje nekoliko ugrađenih naredbi kao što su `/init`, `/undo`, `/redo`, `/share`, `/help`; [saznaj više](/docs/tui#commands).
:::note
