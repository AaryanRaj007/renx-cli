---
title: Deling
description: Del dine Renx-samtaler.
---

Delingsfunksjonen i Renx lar deg lage offentlige lenker til dine Renx-samtaler, slik at du kan samarbeide med lagkamerater eller få hjelp fra andre.
...
Renx støtter tre delingsmoduser som kontrollerer hvordan samtaler deles:

---

### Manuell (standard)

Som standard bruker Renx manuell delingsmodus. Økter deles ikke automatisk, men du kan dele dem manuelt ved å bruke kommandoen `/share`:
...
For å håndheve dette på tvers av teamet ditt for et gitt prosjekt, legg det til `renx.json` i prosjektet ditt og sjekk det inn i Git.
...
[Finn ut mer](/docs/enterprise) om bruk av renx i organisasjonen din.
