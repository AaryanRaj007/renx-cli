---
title: Zen
description: Utvalgt liste over modeller levert av Renx.
---
...
Renx Zen er en liste over testede og verifiserte modeller levert av Renx-teamet.

:::note
Renx Zen er for øyeblikket i beta.
:::

Zen fungerer som enhver annen leverandør i Renx. Du logger inn på Renx Zen og får
...
:::tip
Vi testet en utvalgt gruppe modeller og leverandører som fungerer godt med Renx.
:::
...
Renx Zen er en AI gateway som gir deg tilgang til disse modellene.

---

## Slik fungerer det

Renx Zen fungerer som enhver annen leverandør i Renx.

1. Du logger inn på **<a href={console}>Renx Zen</a>**, legger til
   faktureringsdetaljene dine og kopierer API-nøkkelen din.
2. Du kjører kommandoen `/connect` i TUI, velger Renx Zen og limer inn API-nøkkelen din.
...
[modell-id](/docs/config/#models) i Renx-konfigurasjonen din
bruker formatet `renx/<model-id>`. For eksempel, for GPT 5.5, ville du
brukt `renx/gpt-5.5` i konfigurasjonen din.
...
- MiniMax M2.5 Free er tilgjengelig på Renx i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- Ling 2.6 Flash Free er tilgjengelig på Renx i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- Hy3 Preview Free er tilgjengelig på Renx i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- Nemotron 3 Super Free er tilgjengelig på Renx i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- Big Pickle er en stealth-modell som er gratis på Renx i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
...
4. Ha **ingen lock-in** ved å la deg bruke det med enhver annen kodeagent. Og alltid la deg bruke enhver annen leverandør med Renx også.
