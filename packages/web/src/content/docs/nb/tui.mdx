---
title: TUI
description: Bruke renx-terminalbrukergrensesnittet.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Renx gir et interaktivt terminalgrensesnitt (TUI) for å jobbe med prosjektene dine med en LLM.

Å kjøre Renx starter TUI for gjeldende katalog.
...
Når du bruker Renx TUI, kan du skrive `/` etterfulgt av et kommandonavn for raskt å utføre handlinger. For eksempel:
...
Legg til en leverandør til Renx. Lar deg velge fra tilgjengelige leverandører og legge til deres API-nøkler.
...
Dette er atskilt fra `renx.json`, som konfigurerer server-/kjøretidsoppførsel.
...
Bruk `RENX_TUI_CONFIG` for å laste en egendefinert TUI-konfigurasjonsbane.
