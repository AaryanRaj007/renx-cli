---
title: LSP-servere
description: renx integreres med LSP-serverne dine.
---

Renx integreres med din Language Server Protocol (LSP) for å hjelpe LLM med å samhandle med kodebasen din. Den bruker diagnostikk for å gi tilbakemelding til LLM.

---

## Innebygde servere

Renx kommer med flere innebygde LSP-servere for populære språk:
...
:::note
Du kan deaktivere automatiske LSP-servernedlastinger ved å sette miljøvariabelen `RENX_DISABLE_LSP_DOWNLOAD` til `true`.
:::
...
Når renx åpner en fil, gjør den:
...
Du kan tilpasse LSP-servere gjennom `lsp`-delen i Renx-konfigurasjonen.
