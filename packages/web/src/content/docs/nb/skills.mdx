...
Agentferdigheter lar Renx oppdage gjenbrukbare instruksjoner fra repo- eller hjemmekatalogen din.
...
For prosjektlokale stier går renx opp fra din nåværende arbeidskatalog til den når git-arbeidstreet.
...
renx viser tilgjengelige ferdigheter i `skill`-verktøybeskrivelsen.
...
Kontroller hvilke ferdigheter agenter har tilgang til ved å bruke mønsterbaserte tillatelser i `renx.json`:
