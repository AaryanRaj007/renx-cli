---
title: Zen
description: Curated list of models provided by Renx.
---
...
Renx Zen is a list of tested and verified models provided by the Renx team.

:::note
Renx Zen is currently in beta.
:::

Zen works like any other provider in Renx. You login to Renx Zen and get
...
:::tip
We tested a select group of models and providers that work well with Renx.
:::
...
Renx Zen is an AI gateway that gives you access to these models.

---

## How it works

Renx Zen works like any other provider in Renx.

1. You sign in to **<a href={console}>Renx Zen</a>**, add your billing
   details, and copy your API key.
2. You run the `/connect` command in the TUI, select Renx Zen, and paste your API key.
...
The [model id](/docs/config/#models) in your Renx config
uses the format `renx/<model-id>`. For example, for GPT 5.5, you would
use `renx/gpt-5.5` in your config.
...
- MiniMax M2.5 Free is available on Renx for a limited time. The team is using this time to collect feedback and improve the model.
- Ling 2.6 Flash Free is available on Renx for a limited time. The team is using this time to collect feedback and improve the model.
- Hy3 Preview Flash Free is available on Renx for a limited time. The team is using this time to collect feedback and improve the model.
- Nemotron 3 Super Free is available on Renx for a limited time. The team is using this time to collect feedback and improve the model.
- Big Pickle is a stealth model that's free on Renx for a limited time. The team is using this time to collect feedback and improve the model.
...
4. Have **no lock-in** by allowing you to use it with any other coding agent. And always let you use any other provider with Renx as well.
