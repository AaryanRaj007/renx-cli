---
title: TUI
description: Brug af Renx-terminalbrugergrænsefladen.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Renx giver en interaktiv terminalgrænseflade eller TUI til at arbejde med dine projekter med en LLM.

At køre Renx starter TUI for den nuværende mappe.
...
Når du bruger Renx TUI, kan du skrive `/` efterfulgt af et kommandonavn for hurtigt at udføre handlinger. For eksempel:
...
Tilføj en udbyder til Renx. Lader dig vælge fra tilgængelige udbydere og tilføje deres API-nøgler.
...
Dette er adskilt fra `renx.json`, som konfigurerer server-/kørselstidsadfærd.
...
Brug `RENX_TUI_CONFIG` til at indlæse en brugerdefineret TUI-konfigurationssti.
