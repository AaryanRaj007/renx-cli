...
Agentferdigheter lar Renx oppdage gjenbrugbare instruksjoner fra repo- eller hjemmekatalogen din.
...
Renx søker etter disse stedene:

- Prosjektkonfigurasjon: `.renx/skills/<name>/SKILL.md`
- Global konfigurasjon: `~/.config/renx/skills/<name>/SKILL.md`
...
For prosjektlokale stier går Renx opp fra din nåværende arbejdskatalog til den når git-arbeidstreet.
Den laster alle matchende `skills/*/SKILL.md` i `.renx/` og alle matchende `.claude/skills/*/SKILL.md` eller `.agents/skills/*/SKILL.md` underveis.

Globale definisjoner lastes også inn fra `~/.config/renx/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` og `~/.agents/skills/*/SKILL.md`.
...
Lag `.renx/skills/git-release/SKILL.md` slik:
...
Renx viser tilgængelige ferdigheter i `skill` verktøybeskrivelsen.
...
Kontroller hvilke ferdigheter agenter har tilgang til ved at bruge mønsterbaserte tillatelser i `renx.json`:
...
**For innebygde agenter** (i `renx.json`):
