...
import { IconRenx } from "./icons/custom"
import { ShareI18nProvider, formatCurrency, formatNumber, normalizeLocale } from "./share/common"
import styles from "./share.module.css"
import type { MessageV2 } from "renx/session/message-v2"
import type { Message } from "renx/session/message"
import type { Session } from "renx/session/index"
          ...
          <div data-component="header">
            ...
            <div data-component="header-details">
              <ul data-component="header-stats">
                <li title={props.messages.renx_version} data-slot="item">
                  <div data-slot="icon" title={props.messages.renx_name}>
                    <IconRenx width={16} height={16} />
                  </div>
