...
- PR #15835: https://github.com/anomalyco/renx/pull/15835

## Do Not Translate (Locale Additions)

- `Renx` (preserve casing in prose, docs, and UI copy)
- Keep lowercase `renx` in commands, package names, paths, URLs, and other exact identifiers
...
- Keep product naming consistent: `Renx` in prose, `renx` only for exact technical identifiers
...
- Avoid changing `renx` to `Renx` inside commands, URLs, package names, or code literals
