...
- PR #10018: https://github.com/anomalyco/renx/pull/10018
- PR #12935: https://github.com/anomalyco/renx/pull/12935

## Do Not Translate (Locale Additions)

- `Renx` (preserve casing in prose; keep `renx` only in commands, package names, paths, or code)
- `Renx CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
