...
Use this folder for locale-specific translation guidance that supplements `.renx/agent/translator.md`.
...
- PR #12345: https://github.com/anomalyco/renx/pull/12345

## Do Not Translate (Locale Additions)

- `Renx` (preserve casing)
