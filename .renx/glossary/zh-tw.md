...
- PR #13942: https://github.com/anomalyco/renx/pull/13942

## Do Not Translate (Locale Additions)

- `Renx` (preserve casing in prose; keep `renx` only when it is part of commands, package names, paths, or code)
- `Renx Zen`
- `Renx CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
...
- Avoid `renx` in prose when referring to the product name; use `Renx`
