...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/anomalyco/renx/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for anomalyco/renx...\n")
...
console.log("Fetching npm all-time downloads for renx-ai...\n")
const npmDownloads = await fetchNpmDownloads("renx-ai")
